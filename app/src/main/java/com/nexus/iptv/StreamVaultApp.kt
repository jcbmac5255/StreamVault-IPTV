...
import com.nexus.iptv.diagnostics.RuntimeDiagnosticsManager
import com.nexus.iptv.update.GitHubReleaseChecker
import com.nexus.iptv.ui.accessibility.isReducedMotionEnabled
...
import com.nexus.iptv.data.manager.recording.RecordingReconcileWorker
import com.nexus.iptv.data.sync.ProviderSyncWorker
import com.nexus.iptv.data.sync.XtreamIndexWorker
import com.nexus.iptv.player.timeshift.TimeshiftDiskManager
...
class StreamVaultApp : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        val gcWorkRequest = PeriodicWorkRequestBuilder<com.nexus.iptv.data.sync.SyncWorker>(24, java.util.concurrent.TimeUnit.HOURS)
