...
import com.nexus.iptv.ui.screens.plugins.PluginsScreen
import com.nexus.iptv.ui.screens.provider.ProviderSetupScreen
import com.nexus.iptv.ui.screens.series.SeriesScreen
import com.nexus.iptv.ui.screens.settings.SettingsScreen
import com.nexus.iptv.ui.screens.welcome.WelcomeScreen
import com.nexus.iptv.MainActivity
            ...
            DashboardScreen(
                ...
                onRecentChannelClick = { channel, combinedProfileId ->
                    navController.navigateToPlayer(
                        Routes.livePlayer(
                            channel = channel,
                            categoryId = com.nexus.iptv.domain.model.VirtualCategoryIds.RECENT,
                ...
                onFavoriteChannelClick = { channel, combinedProfileId ->
                    navController.navigateToPlayer(
                        Routes.livePlayer(
                            channel = channel,
                            categoryId = com.nexus.iptv.domain.model.VirtualCategoryIds.FAVORITES,
                            providerId = channel.providerId,
                            isVirtual = true,
                            combinedProfileId = combinedProfileId,
                            returnRoute = Routes.HOME
                ...
                onPlaybackHistoryClick = { history ->
                    val route = when (history.contentType) {
                        com.nexus.iptv.domain.model.ContentType.LIVE -> {
                            Routes.player(
                        ...
                        com.nexus.iptv.domain.model.ContentType.MOVIE -> {
                            Routes.player(
                                streamUrl = history.streamUrl,
                                title = history.title,
                                internalId = history.contentId,
                        ...
                        com.nexus.iptv.domain.model.ContentType.SERIES -> {
                            Routes.seriesDetail(history.contentId, Routes.HOME)
                        }
                        com.nexus.iptv.domain.model.ContentType.SERIES_EPISODE -> {
                            Routes.player(
                                streamUrl = history.streamUrl,
                                title = history.title,
                                internalId = history.contentId,
...
// ... (rest of file)
        ...
        composable(
            ...
            com.nexus.iptv.ui.screens.settings.parental.ParentalControlGroupScreen(
                currentRoute = Routes.SETTINGS,
                onNavigate = { route -> tabNavigate(route) },
                onBack = { navController.popBackStack() }
            )
        ...
        composable(
            ...
            com.nexus.iptv.ui.screens.search.SearchScreen(
        ...
        composable(
            ...
            com.nexus.iptv.ui.screens.movies.MovieDetailScreen(
                onPlay = { movie ->
                    navController.navigateToPlayer(
        ...
        composable(
            ...
            com.nexus.iptv.ui.screens.series.SeriesDetailScreen(
