package com.nexus.iptv.data.remote.xtream

import com.google.common.truth.Truth.assertThat
import com.nexus.iptv.data.remote.NetworkTimeoutConfig
import com.nexus.iptv.data.remote.http.HttpRequestProfile
import com.nexus.iptv.data.remote.dto.XtreamSeriesInfoResponse
...
class OkHttpXtreamApiServiceTest {
    ...
    @Test
    fun `streamLiveStreamRows cancels the underlying call when coroutine times out`() = runBlocking {
